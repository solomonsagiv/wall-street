...
public abstract class TimeSeriesHandler {
    ...
    public static final int INDEX_DELTA = 25;
    public static final int FUT_E1_TICK_SPEED = 26;
    public static final int FUT_DELTA = 27;
    public static final int E1_BID_ASK_COUNTER = 28;
    ...
    public static final int DECISION_FUNCTION = 44;
