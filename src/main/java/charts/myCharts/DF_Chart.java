...
public class DF_Chart extends MyChartCreator {

    public static void main(String[] args) {
        DF_Chart fullChart2 = new DF_Chart(Spx.getInstance());
        fullChart2.createChart();
    }

    // Constructor
    public DF_Chart(BASE_CLIENT_OBJECT client) {
    ...
    public void init() {
        ...
        // ----- Charts ----- //
        MyChart[] charts = {indexChart, df_n_avg_1_chart, df_n_avg_4_chart};
