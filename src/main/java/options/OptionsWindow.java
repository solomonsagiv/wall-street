...
public class OptionsWindow {
    ...
    private void initialize() {
        ...
        int striksNum = client.getExps().getExp(ExpStrings.month).getOptions().getStrikes().size();
        ...
        public void run() {
            ...
            while (run) {
                try {
                    ...
                    colorForfInt(contractCounterField, client.getExps().getExp(ExpStrings.month).getOptions().getConBidAskCounter());
