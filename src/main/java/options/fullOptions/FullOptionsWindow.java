...
public class FullOptionsWindow {
	...
	public JFrame frame;
	public JTable table;
	public String[] headers = { "Vega", "Delta", "Bid", "Theo", "Ask", "Strike", "IV", "Ask", "Theo", "Bid", "Delta", "Vega" };
...
//					downloader.start();
	...
	private void initialize () {
		...
		indexLabel.setBounds ( 499, 0, 99, settingPanel.getHeight ( ) );
		...
		indexPresentLabel.setBounds ( 576, 0, 99, settingPanel.getHeight ( ) );
