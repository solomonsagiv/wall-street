...
public class Themes {
    ...
    // Colors
    public static Color BINANCE_ORANGE = new Color(199, 166, 0);
    public static Color YELLOW = new Color(253, 243, 61);
    public static Color LIFGT_BLUE_2 = new Color(7, 132, 189);
    ...
    public static Color GREY_2 = new Color(255, 255, 255, 104);
    public static Color GREY_3 = new Color(125, 121, 121, 104);
    ...
    public static Color GREEN_LIGHT_4 = new Color(118, 163, 105);
    public static Color GREEN = new Color(0, 128, 0);
    public static Color GREEN_LIGHT = new Color(59, 161, 45);
    public static Color GREEN_LIGHT_2 = new Color(114, 187, 104);
    public static Color GREEN_LIGHT_3 = new Color(144, 182, 150);
    ...
    public static Color LIGHT_RED = new Color(245, 142, 150);
