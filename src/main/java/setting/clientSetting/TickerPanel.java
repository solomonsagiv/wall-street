        ...
        targetBasketChangesField.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    ...
                    client.getBasketFinder_by_stocks().setTargetChanges(num);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        basketUpField.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    ...
                    client.getBasketFinder_by_stocks().setBasketUp(basket);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        basketDownField.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    ...
                    client.getBasketFinder_by_stocks().setBasketDown(basket);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        basketsSleepField.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    ...
                    client.getBasketFinder_by_stocks().setBig_frame_time_in_secondes(sleep);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
