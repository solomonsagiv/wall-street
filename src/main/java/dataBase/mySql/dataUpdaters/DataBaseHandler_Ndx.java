...
public class DataBaseHandler_Ndx extends IDataBaseHandler {
    ...
    public void initTablesNames() {
        ...
        client.getTimeSeriesHandler().put(TimeSeriesFactory.DF_2_RAW, TimeSeriesFactory.getTimeSeries(TimeSeriesFactory.DF_2_RAW, client, MySql.RAW));
        client.getTimeSeriesHandler().put(TimeSeriesFactory.DF_7_RAW, TimeSeriesFactory.getTimeSeries(TimeSeriesFactory.DF_7_RAW, client, MySql.RAW));
