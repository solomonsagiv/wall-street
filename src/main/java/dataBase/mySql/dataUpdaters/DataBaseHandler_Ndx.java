...
public class DataBaseHandler_Ndx extends IDataBaseHandler {
    ...
    public void loadData() {
        ...
        // BASKETS
        load_data_agg(MySql.Queries.get_serie(DATA_SCHEME, "ndx_baskets"), client, null, BASKETS_TYPE);

        //  RACES
        load_data_agg(MySql.Queries.get_serie(SAGIV_SCHEME, "ndx_index_races"), client, null, INDEX_RACES_TYPE);
        load_data_agg(MySql.Queries.get_serie(SAGIV_SCHEME, "ndx_fut_races"), client, null, FUT_RACES_TYPE);
