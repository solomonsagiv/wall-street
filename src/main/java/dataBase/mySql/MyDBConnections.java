...
public class MyDBConnections {
    ...
    public static final int JIBE_PROD = 4;
    ...
    public MyDBConnections() {
        ...
        map.put(JIBE_PROD, new DBConnectionType("jdbc:postgresql://34.203.91.131:5432/jibe", "sagiv", "f19add32-1141-4af5-9abd-4744487f3b51"));
    }
