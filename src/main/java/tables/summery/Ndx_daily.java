...
@Entity
@Table( name = "ndx_daily" )
public class Ndx_daily extends IndexTableSum {
    ...
    public Ndx_daily( String date, String exp_name, double open, double high, double low, double close, int future_up,
