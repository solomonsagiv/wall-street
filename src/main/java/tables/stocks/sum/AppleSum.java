...
@Entity
@Table( name = "apple_sum" )
public class AppleSum extends StockTableSum {

    public AppleSum() {
        super( );
    }

    public AppleSum( String date, String exp_name, double open, double high, double low, double close, int future_up,
